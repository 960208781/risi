	...
	static VoidARSetupScript()
	{
        ...
        if (EditorBuildSettings.scenes.Length == 0 && demoSceneFolder.Exists)
        {
            EditorBuildSettings.scenes = new EditorBuildSettingsScene[]
            {
              ...
              //new EditorBuildSettingsScene("Assets/VoidARDemo/Scenes/shapeDemo.unity", true),
              ...
              new EditorBuildSettingsScene("Assets/VoidARDemo/Scenes/VideoPlayExtensionTrackingDemo.unity", true),
              new EditorBuildSettingsScene("Assets/VoidARDemo/Scenes/ImageExtensionTrackingDemo.unity", true)
            };
        }
